...
var results = []Result{
	{data: []string{""}},
	{data: []string{"ZBXD\x01\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{data: []string{"ZB", "XD\x01\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZB", "XX\x01\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{data: []string{"ZBXD\x01", "\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZBBD\x01", "\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{data: []string{"Z", "B", "X", "D", "\x01", "\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{data: []string{"ZBXD\x01\x00\x00\x00\x00\x00\x00\x00\x00"}},
	{failed: true, data: []string{"ZBX"}},
	{failed: true, data: []string{"ZBXD"}},
	{failed: true, data: []string{"ZBXD\x00\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZBXD\x02\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZBXD\x04\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZBXD\xFF\x0A\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZBXD\x01"}},
	{failed: true, data: []string{"ZBXD\x01\x00\x00\x00\x00"}},
	{data: []string{"Z", "B", "X", "D", "\x01", "\x0A", "\x00", "\x00", "\x00", "\x00", "\x00", "\x00", "\x00", "agent.ping"}},
	{failed: true, data: []string{"Z", "B", "X", "D", "\x01", "\x01\x00\x00\x08\x00\x00\x00\x00", "agent.ping"}},
	{failed: true, data: []string{"ZBXD\x01\x0B\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZBXD\x01\x09\x00\x00\x00\x00\x00\x00\x00agent.ping"}},
	{failed: true, data: []string{"ZBXD\x01\x01\x00\x00\x00\x00\x00\x00"}},
	{data: []string{"ZBXD\x01\x0A\x00\x00", "\x00\x00\x00\x00\x00agent.pi", "ng"}},
	{data: []string{"ZBXD\x01\x0A\x00\x00", "\x00\x00\x00\x00\x00", "a", "g", "e", "n", "t", ".", "p", "i", "n", "g"}},
	{data: []string{"Z", "B", "X", "D", "\x01", "\x0A", "\x00", "\x00", "\x00", "\x00", "\x00", "\x00", "\x00", "a", "g", "e", "n", "t", ".", "p", "i", "n", "g"}},
	...
	{failed: true, data: []string{"ZBXD\x01\x0A\x00\x00\x00\x00\x00\x00\x00"}},
}
