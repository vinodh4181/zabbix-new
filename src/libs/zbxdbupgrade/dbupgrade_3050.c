...
static int	DBpatch_3050008(void)
{
	...
	res = zbx_DBexecute("update events set name='%s' where source=%d and object=%d and value=%d", trdefault,
...
static int	DBpatch_3050009(void)
{
	...
	res = zbx_DBexecute("update problem set name='%s' where source=%d and object=%d ", trdefault,
...
static int	DBpatch_3050010(void)
{
	...
	res = zbx_DBexecute("update events set name='%s' where source=%d and object=%d and value=%d", itdefault,
...
static int	DBpatch_3050011(void)
{
	...
	res = zbx_DBexecute("update problem set name='%s' where source=%d and object=%d", itdefault,
...
static int	DBpatch_3050012(void)
{
	...
	res = zbx_DBexecute("update profiles set idx='web.problem.filter.name' where idx='web.problem.filter.problem'");
...
static int	DBpatch_3050065(void)
{
	...
	ret = zbx_DBexecute("update hosts set auto_compress=0 where status=5 or status=6");
...
static int	DBpatch_3050066(void)
{
	...
	{
		if (ZBX_DB_OK > zbx_DBexecute("update widget set type='%s' where type='%s'", types[i + 1], types[i]))
			return FAIL;
	}
...
static int	DBpatch_3050106(void)
{
	...
	res = zbx_DBexecute("update profiles set value_int=2 where idx='web.problem.filter.evaltype' and value_int=1");
...
static int	DBpatch_3050117(void)
{
	...
	ret = zbx_DBexecute("update problem set acknowledged="
...
static int	DBpatch_3050120(void)
{
	...
	result = zbx_DBselect("select acknowledgeid,eventid,action from acknowledges order by clock");
	while (NULL != (row = zbx_DBfetch(result)))
	{
...
static int	DBpatch_3050122(void)
{
	...
	result = zbx_DBselect("select functionid,parameter from functions where name='logsource'");
...
static int	DBpatch_3050141(void)
{
	...
	ret = zbx_DBexecute("update profiles"
...
static int	DBpatch_3050143(void)
{
	...
	ret = zbx_DBexecute("update widget_field"
...
static int	DBpatch_3050144(void)
{
	...
	/* type : 'problem' - WIDGET_PROBLEMS */
	result = zbx_DBselect("select w.widgetid"
			" from widget w"
...
static int	DBpatch_3050145(void)
{
	...
	ret = zbx_DBexecute("update conditions"
			" set operator=10"
...
static int	DBpatch_3050153(void)
{
	...
	res = zbx_DBexecute("update config set authentication_type=0,http_auth_enabled=1 where authentication_type=2");
...
static int	DBpatch_3050154(void)
{
	...
	res = zbx_DBexecute("update usrgrp set gui_access=3 where gui_access=2");
...
static int	DBpatch_3050155(void)
{
	...
	res = zbx_DBexecute("update config set ldap_configured=1,ldap_case_sensitive=1 where authentication_type=1");
...
static int	DBpatch_3050158(void)
{
	...
	res = zbx_DBexecute("update users set passwd=rtrim(passwd)");
